...
@Mod(value = com.masonwp123.reallights.RealLights.MODID, dist = Dist.CLIENT)
...
public class RealLightsClient {
    ...
    public static void addPackFinders(AddPackFindersEvent event) {
        event.addPackFinders(
                Identifier.fromNamespaceAndPath(com.masonwp123.reallights.RealLights.MODID, "resourcepacks/reallights"),
    ...
    public static boolean addLight(RealLight light) {
        if (lights.size() >= com.masonwp123.reallights.RealLights.MAX_LIGHTS) return false;
        lights.add(light);
